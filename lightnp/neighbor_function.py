...
class Allatoms_NeighborProvider(NeighborProvider):
    """
    ...
    def get_neighbor(self, atoms, grid=None):
...
class AseNeighborProvider(NeighborProvider):
    """
...
class TorchNeighborProvider(NeighborProvider):
    """
...
def collect_atom_triples_batch(neighbors, neighbor_mask):
    ...
    lightnp.md.calculators.SchnetPackCalculator class to generate extended inputs for Behler type symmetry
    functions.
    Args:
